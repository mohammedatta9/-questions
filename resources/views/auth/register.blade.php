...
<body>
  <div id="register-page">
    <section class="height-section-footer section-register bg-brand py-5">
        ...
        <form action="{{ route('register') }}" method="POST">
          ...
          <div v-show="step == 1">
            <div class="row row-gap-24 text-center">
              <div class=" col-md-6  ">
                <div @click="checkUser($event)" class="card-user">
                  <input class="inp-hidd par-inp" type="radio" v-model="user" name="type" value="user" id="">
                  <img src="{{asset('front-assets')}}/img/global/reg-icon1.png" alt="" class="logo-icon">
                  <div class="title">
                    عميل
                  </div>
                  <div class="group-type-user">
                    <div @click="checkMembership($event)" class="card-type-user">
                      <input class="inp-hidd child-inp" type="radio" v-model="membership" name="membership"
                        value="individual" id="">
                      فرد
                    </div>
                    <div @click="checkMembership($event)" class="card-type-user">
              ...
              <div class=" col-md-6  ">
                <div @click="checkUser($event)" class="card-user">
                  <input class="inp-hidd par-inp" type="radio" v-model="user" name="type" value="vendor" id="">
                  <img src="{{asset('front-assets')}}/img/global/reg-icon1.png" alt="" class="logo-icon">
                  <div class="title">
                    مقدم خدمة
                  </div>
            ...
            <div class="mt-4 d-flex justify-content-center ">
              <button @click.prevent="increaseStep()" class="button">
                التالي
              </button>
            </div>
                ...
                <div class="row">
                  ...
                  <div class="col-lg-6">
                    <div class="mb-4">
                      ...
                      <input type="text" class=" form-control" name="third_name" value="{{ old('third_name') }}"
                        v-model="third_name">
                    </div>
                  </div>
                  <div class="col-lg-6">
  ...
  <script>
    ...
    methods: {
        ...
        checkUser(evt) {
            var inp = evt.target.querySelector(".par-inp"),
                inpValue = inp.value;
                this.user = inpValue;
        ...
        checkMembership(evt) {
            var inp = evt.target.querySelector(".child-inp");
                inpValue = inp.value;
                this.membership = inpValue;
                // Add And Remove Active
