                ...
                <div class="col-md-12 px-0 ">
                    <div class="p-3">
                        ...
                        <div class=" mb-4 text-center  position-relative">
                            ...
                            <input type="number" class="form-control remove-arr-num" name="mobile">
                        </div>
                        <div v-show="checkSendCode">
                            ...
                            <input type="number" class="w-25 mx-3 rounded-3 text-center fw-bold inp-code" name="" id="">
                            <input type="number" class="w-25 mx-3 rounded-3 text-center fw-bold inp-code" name="" id="">
                            <input type="number" class="w-25 mx-3 rounded-3 text-center fw-bold inp-code" name="" id="">
                            <input type="number" class="w-25 mx-3 rounded-3 text-center fw-bold inp-code" name="" id="">
                            <input  type="number" class="w-25 mx-3 rounded-3 text-center fw-bold inp-code" name="" id="">
                        ...
                        <div class="mt-2">
                            <button @click="checkSendCode = true; moveCode(); updateTheCounter()" class="main-btn w-100 ">
                                دخول الأن
                            </button>
                        </div>
